...
## Part 1. Build the form

Create a Google Form called **Fractal Fusion, build log entry**. In settings turn
on "Collect email addresses" so you know who submitted what, and turn off
"Limit to 1 response".

Add these questions, in this order. The field name in brackets is the key it
